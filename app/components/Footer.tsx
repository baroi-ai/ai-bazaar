      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex items-center space-x-3">
            {/* Instagram 1 */}
            <a href="https://instagram.com/aibazaar.store" target="_blank" rel="noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-sky-400 hover:bg-zinc-800/80 transition-all shadow-sm focus:outline-none" aria-label="Instagram">
            ...
            {/* Instagram 2 */}
            <a href="https://instagram.com/baroi.ai" target="_blank" rel="noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-sky-400 hover:bg-zinc-800/80 transition-all shadow-sm focus:outline-none" aria-label="Instagram">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" />
                <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" />
            ...
            {/* Chat / Message */}
            <a href="mailto:support@aibazaars.store" className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-sky-400 hover:bg-zinc-800/80 transition-all shadow-sm focus:outline-none" aria-label="Contact">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
            ...
            {/* X (Twitter) */}
            <a href="https://x.com/baroi_ai" target="_blank" rel="noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-sky-400 hover:bg-zinc-800/80 transition-all shadow-sm focus:outline-none" aria-label="X (Twitter)">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0 w-full">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 w-full md:w-auto">
            ...
            <div className="flex items-center space-x-1.5 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full cursor-default group" title="All systems are running normally">
          ...
          <nav className="flex flex-wrap justify-center md:justify-end items-center gap-x-6 gap-y-4 text-xs w-full md:w-auto mt-2 md:mt-0">
            ...
            <Link href="/apps" className={getLinkStyle('/apps')}>Apps</Link>
            <Link href="/pricing" className={getLinkStyle('/pricing')}>Pricing</Link>
            <Link href="/terms" className={getLinkStyle('/terms')}>Terms</Link>
            <Link href="/refund" className={getLinkStyle('/refund')}>Refund</Link>
            <Link href="/privacy" className={getLinkStyle('/privacy')}>Privacy</Link>
          </nav>
